...
Route::middleware(['permission:pos.menu'])->group(function () {
    ...
    Route::get('/pos/search', [PosController::class, 'searchProducts'])->name('pos.searchProducts');
    Route::post('/pos/add-by-barcode', [PosController::class, 'addCartByBarcode'])->name('pos.addCartByBarcode');
