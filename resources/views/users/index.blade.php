                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control" name="search" placeholder="Cari pengguna" value="{{ request('search') }}">
                            ...
                            <td>
                                <form action="{{ route('users.destroy', $item->username) }}" method="POST" style="margin-bottom: 5px">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        ...
                                        <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ubah" href="{{ route('users.edit', $item->username) }}"><i class="ri-pencil-line mr-0"></i> Ubah
                                        </a>
