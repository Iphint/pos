    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Daftar Peran</h4>
                    <p class="mb-0">Dashboard peran memungkinkan Anda mengumpulkan dan memvisualisasikan data peran dengan mudah untuk mengoptimalkan <br>
                                ...
                                <form action="{{ route('role.destroy', $role->id) }}" method="POST" style="margin-bottom: 5px">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ubah"
                                            href="{{ route('role.edit', $role->id) }}""><i class="ri-pencil-line mr-0"></i> Ubah
                                        </a>
