    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Daftar Gaji Di Muka</h4>
                    <p class="mb-0">Dashboard gaji di muka memungkinkan Anda mengumpulkan dan memvisualisasikan data gaji di muka dengan mudah untuk mengoptimalkan <br>
                        pengalaman gaji di muka, memastikan retensi gaji di muka. </p>
                </div>
                <div>
                <a href="{{ route('advance-salary.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus mr-3"></i></i>Tambah Gaji Di Muka</a>
                ...
                <table class="table mb-0">
                    <thead class="bg-white text-uppercase">
                        <tr class="ligth ligth-data">
                            ...
                            <th>@sortablelink('advance_salary', 'Gaji Di Muka')</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>{{ $advance_salary->advance_salary ? 'Rp '.number_format($advance_salary->advance_salary, 0, ',', '.') : 'Tidak Ada' }}</td>
                            <td>
                                <form action="{{ route('advance-salary.destroy', $advance_salary->id) }}" method="POST" style="margin-bottom: 5px">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ubah"
                                            href="{{ route('advance-salary.edit', $advance_salary->id) }}""><i class="ri-pencil-line mr-0"></i> Ubah
                                        </a>
                                        <button type="submit" class="btn btn-warning mr-2 border-none" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Hapus">
