        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dashboard karyawan memungkinkan Anda mengumpulkan dan memvisualisasikan data karyawan dengan mudah untuk mengoptimalkan <br>
                        pengalaman karyawan, memastikan retensi karyawan. </p>
                </div>
                <div>
                            ...
                            <td>
                                    <div class="d-flex align-items-center list-action">
                                        <a class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Lihat"
                                            href="{{ route('employees.show', $employee->id) }}"><i class="ri-eye-line mr-0"></i> Lihat
                                        </a>
                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ubah"
                                            href="{{ route('employees.edit', $employee->id) }}""><i class="ri-pencil-line mr-0"></i> Ubah
                                        </a>
