                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="profile-img-edit">
                                <div class="crm-profile-img-edit">
                                    <img class="crm-profile-pic rounded-circle avatar-100" id="image-preview" src="{{ ($order->customer && $order->customer->photo) ? asset('storage/customers/'.$order->customer->photo) : asset('storage/customers/default.png') }}" alt="profile-pic">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control bg-white" value="{{ $order->customer ? $order->customer->name : 'Pelanggan Umum' }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Email Pelanggan</label>
                            <input type="text" class="form-control bg-white" value="{{ $order->customer ? $order->customer->email : '-' }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>No. HP Pelanggan</label>
                            <input type="text" class="form-control bg-white" value="{{ $order->customer ? $order->customer->phone : '-' }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex align-items-center list-action">
                                    <form action="{{ route('order.updateStatus') }}" method="POST" style="margin-bottom: 5px">
                                        ...
                                        <a class="btn btn-danger mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Batal" href="{{ route('order.pendingOrders') }}">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>
