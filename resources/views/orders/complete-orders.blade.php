                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail" href="{{ route('order.orderDetails', $order->id) }}">
                                        Detail
                                    </a>
                                    <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cetak" href="{{ route('order.invoiceDownload', $order->id) }}">
                                        Cetak
                                    </a>
                                </div>
                            </td>
