        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    ...
                    <p class="mb-0">Dashboard pemasok memungkinkan Anda mengumpulkan dan memvisualisasikan data pemasok dengan mudah untuk mengoptimalkan <br>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Lihat"
                                        href="{{ route('suppliers.show', $supplier->id) }}"><i class="ri-eye-line mr-0"></i> Lihat
                                    </a>
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ubah"
                                        href="{{ route('suppliers.edit', $supplier->id) }}""><i class="ri-pencil-line mr-0"></i> Ubah
                                    </a>
