                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4" style="margin-top: -20px">
                                            <div class="text-danger small">Username atau kata sandi salah.</div>
                                        </div>
                                        @enderror
                                        @error('email')
                                        <div class="mb-4" style="margin-top: -20px">
                                    ...
                                    <div class="col-lg-6">
                                        <p>
                                            Belum menjadi Member? <a href="{{ route('register') }}" class="text-primary">Daftar</a>
                                        </p>
                                    </div>
                                    <div class="col-lg-6">
                                        <a href="#" class="text-primary float-right">Lupa Kata Sandi?</a>
                                    </div>
                                </div>
