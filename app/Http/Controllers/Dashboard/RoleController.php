...
class RoleController extends Controller
{
    ...
    public function permissionStore(Request $request)
    {
        ...
        return Redirect::route('permission.index')->with('success', 'Izin berhasil dibuat!');
    }
    ...
    public function permissionUpdate(Request $request, Int $id)
    {
        ...
        return Redirect::route('permission.index')->with('success', 'Izin berhasil diperbarui!');
    }
    ...
    public function permissionDestroy(Int $id)
    {
        ...
        return Redirect::route('permission.index')->with('success', 'Izin berhasil dihapus!');
    }
    ...
    public function rolePermissionStore(Request $request)
    {
        ...
        return Redirect::route('rolePermission.index')->with('success', 'Role Izin berhasil dibuat!');
    }
    ...
    public function rolePermissionUpdate(Request $request, Int $id)
    {
        ...
        return Redirect::route('rolePermission.index')->with('success', 'Role Izin berhasil diperbarui!');
    }
    ...
    public function rolePermissionDestroy(Int $id)
    {
        ...
        return Redirect::route('rolePermission.index')->with('success', 'Role Izin berhasil dihapus!');
    }
}
